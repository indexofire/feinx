...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('account_profile', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='account_profile', unique=True, null=True, to=orm['auth.User'])),
            ...
            ('forum_signature', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('rank', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1, max_length=2)),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 12, 22, 55, 11523)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 13, 12, 22, 55, 11426)'}),
